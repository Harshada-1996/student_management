...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { bk_category: @library.bk_category, lib_type: @library.lib_type } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { bk_category: @library.bk_category, lib_type: @library.lib_type } }
